  ...
  return (
    <>
      ...
      <form id="search-form">
        <div>
          <label>Search:</label>
          <input type="text" required placeholder='Insert Query Here' id="searchBox" />
        </div>
      ...
      <div id="hilux">
        <p>
          <img src="src/assets/toyota_hilux.jpg" className="d-block w-50 rounded centered" alt="..." />
        </p>
      ...
      <div id="Lambo_R8">
        <p>
          <img src="src/assets/lambo_tractor.jpg" className="d-block w-50 rounded centered" alt="..." />
        </p>
        <h1 className="d-flex align-items-center justify-content-center mt-3">
          Lamborghini R8
        </h1>
      ...
      <div id="Z8">
        <p>
          <img src="src/assets/Z8.jpg" className="d-block w-50 rounded centered" alt="..." />
        </p>
        <h1 className="d-flex align-items-center justify-content-center mt-3">
          BMW Z8
        </h1>
      ...
      <div id="GTR">
        <p>
          <img src="src/assets/GTR.jpg" className="d-block w-50 rounded centered" alt="..." />
        </p>
        <h1 className="d-flex align-items-center justify-content-center mt-3">
          Nissan GT-R
        </h1>
      ...
      <div id="autozam">
        <p>
          <img src="src/assets/autozam.jpg" className="d-block w-50 rounded centered" alt="..." />
        </p>
        <h1 className="d-flex align-items-center justify-content-center mt-3">
          1993 Autozam AZ-1
        </h1>
      ...
      <div id="supra">
        <p>
          <img src="src/assets/supra.jpg" className="d-block w-50 rounded centered" alt="..." />
        </p>
        <h1 className="d-flex align-items-center justify-content-center mt-3">
          1997 Toyota Supra
        </h1>
